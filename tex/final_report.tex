...
%\footnote{With that said, our compute and memory resources are limited so we restricted our training dataset to 128000 start-stop board pairs}. 
...
\begin{figure}
    \centering
    \includegraphics[scale=0.85]{MAE-different-Fs.png}
...
\begin{figure}[!h]
    \centering
    \includegraphics[scale=0.85]{MAE-uniform-noise.png}
...
\begin{figure}[!h]
    \centering
    \includegraphics[scale=0.85]{MAE-loss-hist-sm.png}
